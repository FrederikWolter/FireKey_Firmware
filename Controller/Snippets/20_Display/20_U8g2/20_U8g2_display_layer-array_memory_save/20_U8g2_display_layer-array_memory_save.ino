...
* FIREKEY - PROJECT
* 
* Code snippet to test the display for multi layer usage using arrays (save memory)
* 
* Required Libs:
* - U8g2 Lib(https://github.com/olikraus/u8g2)
*    -> can be installed via Arduino IDE
* - avr/pgmspace lib
*    -> is already installed (arduino pro micro)
*********************************************************************/
...
void loop() {
  //Serial.println(freeMemory()); //1669 byte free regardless of the number of layers
  readMatrix();
